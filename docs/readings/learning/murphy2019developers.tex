...
% a lot of these tools mentioned as examples probably would not be under my use-case (cause they're not JAM-stack), so its reasonable to talk about breadth of applicability
